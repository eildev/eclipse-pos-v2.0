...
class SaleController extends Controller
{
        ...
        try {
            ...
            foreach ($variants as $item) {
                ...
                if ($settings->selling_price_update === 1) {
                    ...
                    } else if ($settings->sale_price_type === 'b2c_price') {
    ...
    public function filter(Request $request)
    {
        ...
        $salesTable = view('pos.sale.sale_filter.table', compact('sales'))->render();
    ...
    public function SaleInvoiceFilter()
    {
        ...
        return view('pos.sale.sale_filter.sale_filter', compact('sales', 'salesInvoice', 'banks'));
    }
