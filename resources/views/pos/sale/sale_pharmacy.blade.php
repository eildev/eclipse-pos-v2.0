...
<label for="offcanvas-toggle" style="position: fixed; font-size:20px; top: 65px; right: 20px; z-index: 1000; cursor: pointer;">
    ...
    <div class="{{ $invoice_payment == 1 ? 'col-lg-8' : 'col-lg-12' }} stretch-card mb-1">
        <div class="card">
    ...
    <div class="row">
        <div class="{{ $warranty_status == 1 ? 'col-lg-12' : 'col-lg-8' }}  mb-1  stretch-card">
            <div class="card">
                <div class="card-body px-4 py-2">
        ...
        <div class="{{ $warranty_status == 1 ? 'col-lg-5' : 'col-lg-4' }} mb-1  stretch-card">
            <div class="card">
                <div class="card-body px-4 py-2">
