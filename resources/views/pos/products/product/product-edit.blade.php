                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <label for="ageSelect" class="form-label">Category <span
                                        class="text-danger">*</span></label>
                                <select class="form-select js-example-basic-single category_id" id="category_name" name="category_id"
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select class="form-select js-example-basic-single brand_id" name="brand_id" onchange="errorRemove(this);">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" class="form-control" value="{{ $product->defaultVariationsEdit->model_no }}" name="model_no">
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control b2c_price" name="b2c_price" type='number'
                                    placeholder="00.00" value="{{ $product->defaultVariationsEdit->b2c_price ?? 0 }}" onkeyup="errorRemove(this);" onblur="errorRemove(this);" />
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control b2b__price" name="b2b_price" type='number'
                                    placeholder="00.00" value="{{ $product->defaultVariationsEdit->b2b_price ?? 0 }}" onkeyup="errorRemove(this);" onblur="errorRemove(this);" />
                                <span class="text-danger b2b_price_error"></span>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label class="form-label">Origin</label>
                                <select class="js-example-basic-single form-select" name="origin" onchange="errorRemove(this);">
                                    <option selected disabled>Select Origin</option>
                                    <option value="cn" {{ old('origin', $product->defaultVariationsEdit->origin) == 'cn' ? 'selected' : '' }}>China</option>
                                    <option value="in" {{ old('origin', $product->defaultVariationsEdit->origin) == 'in' ? 'selected' : '' }}>India</option>
                                    <option value="us" {{ old('origin', $product->defaultVariationsEdit->origin) == 'us' ? 'selected' : '' }}>United States</option>
                                    <option value="id" {{ old('origin', $product->defaultVariationsEdit->origin) == 'id' ? 'selected' : '' }}>Indonesia</option>
                                    <option value="pk" {{ old('origin', $product->defaultVariationsEdit->origin) == 'pk' ? 'selected' : '' }}>Pakistan</option>
                                    <option value="br" {{ old('origin', $product->defaultVariationsEdit->origin) == 'br' ? 'selected' : '' }}>Brazil</option>
                                    <option value="ng" {{ old('origin', $product->defaultVariationsEdit->origin) == 'ng' ? 'selected' : '' }}>Nigeria</option>
                                    <option value="bd" {{ old('origin', $product->defaultVariationsEdit->origin) == 'bd' ? 'selected' : '' }}>Bangladesh</option>
                                    <option value="ru" {{ old('origin', $product->defaultVariationsEdit->origin) == 'ru' ? 'selected' : '' }}>Russia</option>
                                    <option value="mx" {{ old('origin', $product->defaultVariationsEdit->origin) == 'mx' ? 'selected' : '' }}>Mexico</option>
                                </select>
                    ...
                    <div class="card-body">
                        <div class="row ">
                            ...
                            <div class="mb-3 col-md-10">
                                ...
                                <select class="form-control js-example-basic-single show_color" name="color" data-selected-color-id="{{ $product->defaultVariationsEdit->color }}">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-control js-example-basic-single" name="quality">
                                    ...
                                    <option value="grade-a" {{ old('quality', $product->defaultVariationsEdit->quality) == 'grade-a' ? 'selected' : '' }}>Grade A</option>
                                    <option value="grade-b" {{ old('quality', $product->defaultVariationsEdit->quality) == 'grade-b' ? 'selected' : '' }}>Grade B</option>
                                    <option value="grade-c" {{ old('quality', $product->defaultVariationsEdit->quality) == 'grade-c' ? 'selected' : '' }}>Grade C</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <select class="form-select unit js-example-basic-single" name="unit" onchange="errorRemove(this);">
                ...
                <div class="card-body">
                    <form id="variationForm">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <button type="button" class="btn btn-primary" id="addVariationRowBtn">Add New Variation</button>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($product->variations as $variation)
                                        <tr data-variation-id="{{ $variation->id }}">
                                            <td>
                                                <button type="button" class="btn btn-danger btn-sm deleteVariationBtn" data-variation-id="{{ $variation->id }}">
                                            ...
                                            <td>
                                                ...
                                                <input type="number" class="form-control" name="current_stock[]" value="{{ $variation->stocks->first()->stock_quantity ?? 0 }}">
                                            </td>
                                            <td><input type="number" class="form-control" name="cost_price[]" value="{{ $variation->cost_price }}"></td>
                                            <td><input type="number" class="form-control" name="b2b_price[]" value="{{ $variation->b2b_price }}"></td>
                                            <td><input type="number" class="form-control" name="b2c_price[]" value="{{ $variation->b2c_price }}"></td>
                                            <td style="width: 150px;">
                                                <select class="form-control js-example-basic-single" name="size[]">
                                                    @foreach ($sizes as $size)
                                                        <option value="{{ $size->id }}" {{ $size->id == $variation->size ? 'selected' : '' }}>{{ $size->size }}</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                            <td style="width: 150px;">
                                                <select class="form-control show_color js-example-basic-single" name="color[]" data-selected-color-id="{{ $variation->color }}">

                                                </select>
                                            </td>
                                            <td><input type="text" class="form-control" name="model_no[]" value="{{ $variation->model_no }}"></td>
                                            <td>
                                                <select class="form-control" name="quality[]">
                                                    <option value="grade-a" {{ $variation->quality == 'grade-a' ? 'selected' : '' }}>Grade A</option>
                                                    <option value="grade-b" {{ $variation->quality == 'grade-b' ? 'selected' : '' }}>Grade B</option>
                                                    <option value="grade-c" {{ $variation->quality == 'grade-c' ? 'selected' : '' }}>Grade C</option>
                                                </select>
                                            </td>
                                            <td>
                                                <input type="file"  class="form-control" name="image[]">
                                                @if ($variation->image)
                                                    <img src="{{ asset('uploads/products/' . $variation->image) }}" width="50" height="50">
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        <button type="submit" class="btn btn-success mt-3 variationStoreUpdate">Update Variations</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        variationStoreUpdate.addEventListener('click', function(e) {
            ...
            .trim(); // Use `input` for model_no[] if it's an input field.
                ...
                let colorVari = row.querySelector('select[name="color[]"]').value; // Use `input` for color[] if it's an input field.

                const validSize = sizeVari !== '' && sizeVari !== 'Select Size';
                const validQuality = qualityVari !== '' && qualityVari !== 'Select Quality';
                const validColor = colorVari !== '' && colorVari !== 'Select Color'; // Treat '#000000' as invalid.
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 200) {
                        ...
                        Swal.fire(
                            'Error!',
                            response.message || 'Unable to delete the variation.',
                            'error'
                        );
                    }
                },
                error: function (xhr) {
                    Swal.fire(
                        'Error!',
                        xhr.responseJSON?.message || 'An error occurred while deleting the variation.',
                        'error'
                    );
                }
            });
